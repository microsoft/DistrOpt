...
int main_test_disco(int argc, char* argv[])
//int main(int argc, char* argv[])
{
	...
	params.pcg_itrs = 100;
	params.pcg_mu = 1e-5;
	params.pcg_adpt = false;
	params.pcg_polak = true;
	params.pcg_display = false;

	disco_omp(X, y, *f, lambda, g, w, m, params);
